package com.lingyun.test1.tool;
...
/**
 * @ClassName UserExcelWriteListener
 * @Description TODO
 * @Author LingYun
 ...
 */
@Slf4j
public class UserExcelWriteListener implements ReadListener<User> {

    private UserService userService;

    public UserExcelWriteListener(UserService userService) {
